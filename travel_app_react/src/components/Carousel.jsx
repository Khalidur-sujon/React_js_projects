...
function Carousel() {
	...
	return (
		<div className="max-w-[1280px] mx-auto px-4 my-8 flex justify-center items-center relative ">
			<div className="absolute top-[50%] text-3xl text-white cursor-pointer w-full h-full flex justify-between">
